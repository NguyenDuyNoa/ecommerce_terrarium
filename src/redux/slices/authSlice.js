...
export const register = createAsyncThunk("register", async (newUser) => {
  const res = await axios.post(`https://deploy-terrarium.vercel.app/users`, newUser);
  return res.data;
});

export const login = createAsyncThunk("login", async (inforLogin) => {
  const res = await axios.get(`https://deploy-terrarium.vercel.app/users`);
  return {
    users: res.data,
...
export const deleteUser = createAsyncThunk("deleteUser", async (id) => {
  const res = await axios.delete(`https://deploy-terrarium.vercel.app/users/` + id);
  return res
})

export const editUser = createAsyncThunk("editUser", async ({ updatedUser }) => {
  const res = await axios.put(`https://deploy-terrarium.vercel.app/users/${updatedUser.id}`, updatedUser);
  return res.data;
});
